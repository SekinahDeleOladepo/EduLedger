...
namespace EduLedger.Migrations
{
    ...
    [Migration("20260220114530_AddAcademicRecord")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLedger.Data.ClassLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduLedger.Data.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationUserCourse", b =>
                {
                    b.HasOne("EduLedger.Data.Course", null)
                        .WithMany()
                        .HasForeignKey("EnrolledCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduLedger.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EduLedger.Data.ApplicationUser", b =>
                {
                    b.HasOne("EduLedger.Data.ClassLevel", "ClassLevel")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("EduLedger.Data.Course", b =>
                {
                    ...
                    b.HasOne("EduLedger.Data.ApplicationUser", "Instructor")
            ...
            modelBuilder.Entity("EduLedger.Data.UserProfile", b =>
                {
                    b.HasOne("EduLedger.Data.ApplicationUser", "ApplicationUser")
                        .WithOne("UserProfile")
                        .HasForeignKey("EduLedger.Data.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
